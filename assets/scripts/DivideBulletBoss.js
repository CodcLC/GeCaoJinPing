    ...
    m =
        ...
        (function (e) {
            function t() {
                ...
                return (
                    (t.checkCd = function () {
                        if (!p.gameMgr.getIsPause() && ((t.cd -= 0.1), t.cd <= 0)) {
                            var e = t.skillArr;
                            l.loadMgr.getEnemyBullet(e.getSkillUrl()) && t.doSkillByIndex();
                        }
                    }),
                    t
                );
            ...
            return (
                    ...
                    return r(this, void 0, Promise, function () {
                        return s(this, function () {
                            return (
                                ...
                                (this.radius = 100),
                                l.loadMgr.loadEnemyBullet("boomBullet"),
                                l.loadMgr.loadEnemyBullet("enemyBullet"),
                                [2]
                            );
                        });
                    });
                ...
                (t.prototype.doSkillByIndex = function () {
                    ...
                    for (var o = 0; o < t.getBossBulletCount(); o++)
                        this.scheduleOnce(function () {
                            if (t) {
                                var o = l.loadMgr.getEnemyBullet(t.getSkillUrl());
                                o &&
                                    u.poolMgr
                                        .getNodeFromMap(o)
                                        .getComponent(d.default)
                                        .init(e.damage(), e.getPos(), Object.assign({}, t.getJson()), e.enemyJson.type);
                            }
                        }, 0.15 * o);
                }),
                i([g], t)
