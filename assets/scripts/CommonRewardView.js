        ...
        return (
                    ...
                    e.init(),
                        e.mask.on(cc.Node.EventType.TOUCH_END, function () {
                            p.audioMgr.startEffect(u.AudioConst.COMMON_TOUCH),
                                d.playData.getNewUserStep() === g.GUIDE_STEP.EQUIP
                                    ? h.ClientEvents.REFRESH_GUIDE.emit()
                                    : d.playData.getFailGuideStep() === g.FAIL_GUIDE.SHOP
                                    ? h.ClientEvents.REFRESH_FAIL_GUIDE.emit()
                                    : d.playData.getFailGuideStep() === g.FAIL_GUIDE.EQUIP &&
                                      h.ClientEvents.REFRESH_FAIL_GUIDE.emit(),
                                e.closeView(e.isAutoPop),
                                h.ClientEvents.REFRESH_ACTIVITY_BINGO.emit();
                        });
                });
            }),
            (t.prototype.start = function () {
                m.wxMgr.showBanner({openUi: s.ViewUrl.commonRewardView, placementName: ""});
            }),
            ...
            (t.prototype.init = function () {
                ...
                this.data.forEach(function (t, o) {
                    ...
                    e.layout.addChild(n), n.getComponent(l.default).init(o, t.id, t.count);
                });
            }),
            (t.prototype.getUrl = function () {
                return s.ViewUrl.commonRewardView;
            }),
            i([v(cc.Node)], t.prototype, "aniNode", void 0),
            i([v(cc.Node)], t.prototype, "shikariNode", void 0),
